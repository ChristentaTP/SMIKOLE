...
export default function LogbookDetailModal({ isOpen, logbook, onClose, onDelete, isLoading = false }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal Content */}
      <div className="relative bg-white rounded-xl shadow-lg mx-4 max-w-md w-full animate-fade-in max-h-[90vh] flex flex-col">
        {/* Header */}
        ...
        <div className="p-4 space-y-4 overflow-y-auto grow">
          ...
          <div className="flex items-center gap-2 text-gray-600">
            <FontAwesomeIcon icon={faCalendar} className="text-[#085C85]" />
