...
export default function ActuatorStatusModal({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal Content */}
      <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 mx-4 max-w-sm w-full animate-fade-in">
        {/* Header */}
        <div className="text-center mb-6">
          <h2 className="text-lg font-bold text-gray-800 dark:text-white">Status Aktuator</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{actuatorName}</p>
        </div>

        {/* Mode Section */}
        <div className="bg-[#E8F5E9] dark:bg-green-900/20 rounded-xl p-4 mb-4">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <p className="text-sm font-semibold text-gray-700 dark:text-gray-200">Mode Kontrol</p>
        ...
        {mode === "manual" && (
          <div className="bg-[#FFF3E0] dark:bg-orange-900/20 rounded-xl p-4 mb-4 animate-fade-in">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <p className="text-sm font-semibold text-gray-700 dark:text-gray-200">Kontrol Power</p>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
        ...
        {/* Status Info */}
        <div className="border border-gray-200 dark:border-gray-600 rounded-xl p-4 mb-6">
        ...
        <div className="flex justify-center gap-4">
          <button
            onClick={onClose}
            className="bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 font-semibold px-6 py-2.5 rounded-lg border-2 border-gray-300 dark:border-gray-500 transition-colors duration-200"
          >
            Batal
          </button>
          <button
